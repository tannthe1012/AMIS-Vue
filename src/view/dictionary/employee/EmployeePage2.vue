...
export default {
  ...
  methods: {
    ...
    fotmatDataCbb(result, type) {
      switch (type) {
        case "position":
          // this.findId(result, this.position);
          console.log(this.findId(result, this.position));
          break;
        case "department":
          // let id = this.findId(result, this.department);
          console.log(this.findId(result, this.department));   
          break;
        default:
          break;
      }
     ...
     */
    findId(result, array) {
      if(result == "Tất cả vị trí" || result == "Tất cả phòng ban" || result=="") {
        return "";
      }
